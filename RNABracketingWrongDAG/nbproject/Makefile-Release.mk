...
${OBJECTDIR}/BucketWorkflowDistributor.o: BucketWorkflowDistributor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BucketWorkflowDistributor.o BucketWorkflowDistributor.cpp
...
${OBJECTDIR}/LongestPathCreator.o: LongestPathCreator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LongestPathCreator.o LongestPathCreator.cpp
...
${OBJECTDIR}/TopoSort.o: TopoSort.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TopoSort.o TopoSort.cpp
...
${TESTDIR}/tests/bucketworkflowtest.o: tests/bucketworkflowtest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/bucketworkflowtest.o tests/bucketworkflowtest.cpp


${TESTDIR}/tests/inputprocessottest.o: tests/inputprocessottest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/inputprocessottest.o tests/inputprocessottest.cpp


${TESTDIR}/tests/iterationcontrollertest.o: tests/iterationcontrollertest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/iterationcontrollertest.o tests/iterationcontrollertest.cpp


${TESTDIR}/tests/longestpathcreatortest.o: tests/longestpathcreatortest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/longestpathcreatortest.o tests/longestpathcreatortest.cpp


${TESTDIR}/tests/randomgeneratortest.o: tests/randomgeneratortest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/randomgeneratortest.o tests/randomgeneratortest.cpp


${TESTDIR}/tests/toposorttest.o: tests/toposorttest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/toposorttest.o tests/toposorttest.cpp
...
${OBJECTDIR}/BucketWorkflowDistributor_nomain.o: ${OBJECTDIR}/BucketWorkflowDistributor.o BucketWorkflowDistributor.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BucketWorkflowDistributor_nomain.o BucketWorkflowDistributor.cpp;\
	else  \
...
${OBJECTDIR}/LongestPathCreator_nomain.o: ${OBJECTDIR}/LongestPathCreator.o LongestPathCreator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LongestPathCreator_nomain.o LongestPathCreator.cpp;\
	else  \
...
${OBJECTDIR}/TopoSort_nomain.o: ${OBJECTDIR}/TopoSort.o TopoSort.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TopoSort_nomain.o TopoSort.cpp;\
	else  \
