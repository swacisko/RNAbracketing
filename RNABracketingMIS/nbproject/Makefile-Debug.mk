...
${OBJECTDIR}/DisjointComponentMerger.o: DisjointComponentMerger.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DisjointComponentMerger.o DisjointComponentMerger.cpp

${OBJECTDIR}/GlobalIterator.o: GlobalIterator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GlobalIterator.o GlobalIterator.cpp
...
${OBJECTDIR}/GraphConnectedComponents.o: GraphConnectedComponents.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphConnectedComponents.o GraphConnectedComponents.cpp
...
${OBJECTDIR}/MIS.o: MIS.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MIS.o MIS.cpp

${OBJECTDIR}/MISNodes.o: MISNodes.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MISNodes.o MISNodes.cpp

${OBJECTDIR}/Makros.o: Makros.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Makros.o Makros.cpp
...
${OBJECTDIR}/ResultTester.o: ResultTester.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ResultTester.o ResultTester.cpp
...
${TESTDIR}/tests/mistest.o: tests/mistest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/mistest.o tests/mistest.cpp
...
${OBJECTDIR}/DisjointComponentMerger_nomain.o: ${OBJECTDIR}/DisjointComponentMerger.o DisjointComponentMerger.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DisjointComponentMerger_nomain.o DisjointComponentMerger.cpp;\
	else  \
...
${OBJECTDIR}/GlobalIterator_nomain.o: ${OBJECTDIR}/GlobalIterator.o GlobalIterator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GlobalIterator_nomain.o GlobalIterator.cpp;\
	else  \
...
${OBJECTDIR}/GraphConnectedComponents_nomain.o: ${OBJECTDIR}/GraphConnectedComponents.o GraphConnectedComponents.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphConnectedComponents_nomain.o GraphConnectedComponents.cpp;\
	else  \
...
${OBJECTDIR}/MIS_nomain.o: ${OBJECTDIR}/MIS.o MIS.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MIS_nomain.o MIS.cpp;\
	else  \
...
${OBJECTDIR}/MISNodes_nomain.o: ${OBJECTDIR}/MISNodes.o MISNodes.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MISNodes_nomain.o MISNodes.cpp;\
	else  \
...
${OBJECTDIR}/Makros_nomain.o: ${OBJECTDIR}/Makros.o Makros.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Makros_nomain.o Makros.cpp;\
	else  \
...
${OBJECTDIR}/ResultTester_nomain.o: ${OBJECTDIR}/ResultTester.o ResultTester.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ResultTester_nomain.o ResultTester.cpp;\
	else  \
